#[doc = "Register `SLC1_INT_ST` reader"]
pub type R = crate::R<SLC1_INT_ST_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SLC1_INT_ST_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slc1_int_st::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SLC1_INT_ST_SPEC;
impl crate::RegisterSpec for SLC1_INT_ST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slc1_int_st::R`](R) reader structure"]
impl crate::Readable for SLC1_INT_ST_SPEC {}
#[doc = "`reset()` method sets SLC1_INT_ST to value 0"]
impl crate::Resettable for SLC1_INT_ST_SPEC {
