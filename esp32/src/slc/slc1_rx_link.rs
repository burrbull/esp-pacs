#[doc = "Register `SLC1_RX_LINK` reader"]
pub type R = crate::R<SLC1_RX_LINK_SPEC>;
#[doc = "Register `SLC1_RX_LINK` writer"]
pub type W = crate::W<SLC1_RX_LINK_SPEC>;
...
#[doc = "Field `BT_PACKET` reader - "]
pub type BT_PACKET_R = crate::BitReader;
#[doc = "Field `BT_PACKET` writer - "]
pub type BT_PACKET_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn bt_packet(&self) -> BT_PACKET_R {
        BT_PACKET_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SLC1_RX_LINK")
            .field(
                "rxlink_addr",
                &format_args!("{}", self.rxlink_addr().bits()),
            )
            .field("bt_packet", &format_args!("{}", self.bt_packet().bit()))
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SLC1_RX_LINK_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxlink_addr(&mut self) -> RXLINK_ADDR_W<SLC1_RX_LINK_SPEC> {
        RXLINK_ADDR_W::new(self, 0)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn bt_packet(&mut self) -> BT_PACKET_W<SLC1_RX_LINK_SPEC> {
        BT_PACKET_W::new(self, 20)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn rxlink_stop(&mut self) -> RXLINK_STOP_W<SLC1_RX_LINK_SPEC> {
        RXLINK_STOP_W::new(self, 28)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn rxlink_start(&mut self) -> RXLINK_START_W<SLC1_RX_LINK_SPEC> {
        RXLINK_START_W::new(self, 29)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn rxlink_restart(&mut self) -> RXLINK_RESTART_W<SLC1_RX_LINK_SPEC> {
        RXLINK_RESTART_W::new(self, 30)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slc1_rx_link::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`slc1_rx_link::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SLC1_RX_LINK_SPEC;
impl crate::RegisterSpec for SLC1_RX_LINK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slc1_rx_link::R`](R) reader structure"]
impl crate::Readable for SLC1_RX_LINK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`slc1_rx_link::W`](W) writer structure"]
impl crate::Writable for SLC1_RX_LINK_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SLC1_RX_LINK to value 0x0010_0000"]
impl crate::Resettable for SLC1_RX_LINK_SPEC {
