#[doc = "Register `SLC1_INT_ENA` reader"]
pub type R = crate::R<SLC1_INT_ENA_SPEC>;
#[doc = "Register `SLC1_INT_ENA` writer"]
pub type W = crate::W<SLC1_INT_ENA_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SLC1_INT_ENA_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit(&mut self, n: u8) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit8(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 0)
    }
    #[doc = "Bit 1 - FRHOST_BIT9"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit9(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 1)
    }
    #[doc = "Bit 2 - FRHOST_BIT10"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit10(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 2)
    }
    #[doc = "Bit 3 - FRHOST_BIT11"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit11(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 3)
    }
    #[doc = "Bit 4 - FRHOST_BIT12"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit12(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 4)
    }
    #[doc = "Bit 5 - FRHOST_BIT13"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit13(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 5)
    }
    #[doc = "Bit 6 - FRHOST_BIT14"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit14(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 6)
    }
    #[doc = "Bit 7 - FRHOST_BIT15"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit15(&mut self) -> FRHOST_BIT_W<SLC1_INT_ENA_SPEC> {
        FRHOST_BIT_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn rx_start(&mut self) -> RX_START_W<SLC1_INT_ENA_SPEC> {
        RX_START_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn tx_start(&mut self) -> TX_START_W<SLC1_INT_ENA_SPEC> {
        TX_START_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn rx_udf(&mut self) -> RX_UDF_W<SLC1_INT_ENA_SPEC> {
        RX_UDF_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn tx_ovf(&mut self) -> TX_OVF_W<SLC1_INT_ENA_SPEC> {
        TX_OVF_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn token0_1to0(&mut self) -> TOKEN0_1TO0_W<SLC1_INT_ENA_SPEC> {
        TOKEN0_1TO0_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn token1_1to0(&mut self) -> TOKEN1_1TO0_W<SLC1_INT_ENA_SPEC> {
        TOKEN1_1TO0_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn tx_done(&mut self) -> TX_DONE_W<SLC1_INT_ENA_SPEC> {
        TX_DONE_W::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn tx_suc_eof(&mut self) -> TX_SUC_EOF_W<SLC1_INT_ENA_SPEC> {
        TX_SUC_EOF_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn rx_done(&mut self) -> RX_DONE_W<SLC1_INT_ENA_SPEC> {
        RX_DONE_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn rx_eof(&mut self) -> RX_EOF_W<SLC1_INT_ENA_SPEC> {
        RX_EOF_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn tohost(&mut self) -> TOHOST_W<SLC1_INT_ENA_SPEC> {
        TOHOST_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dscr_err(&mut self) -> TX_DSCR_ERR_W<SLC1_INT_ENA_SPEC> {
        TX_DSCR_ERR_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn rx_dscr_err(&mut self) -> RX_DSCR_ERR_W<SLC1_INT_ENA_SPEC> {
        RX_DSCR_ERR_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dscr_empty(&mut self) -> TX_DSCR_EMPTY_W<SLC1_INT_ENA_SPEC> {
        TX_DSCR_EMPTY_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn host_rd_ack(&mut self) -> HOST_RD_ACK_W<SLC1_INT_ENA_SPEC> {
        HOST_RD_ACK_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn wr_retry_done(&mut self) -> WR_RETRY_DONE_W<SLC1_INT_ENA_SPEC> {
        WR_RETRY_DONE_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn tx_err_eof(&mut self) -> TX_ERR_EOF_W<SLC1_INT_ENA_SPEC> {
        TX_ERR_EOF_W::new(self, 24)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slc1_int_ena::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`slc1_int_ena::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SLC1_INT_ENA_SPEC;
impl crate::RegisterSpec for SLC1_INT_ENA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slc1_int_ena::R`](R) reader structure"]
impl crate::Readable for SLC1_INT_ENA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`slc1_int_ena::W`](W) writer structure"]
impl crate::Writable for SLC1_INT_ENA_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SLC1_INT_ENA to value 0"]
impl crate::Resettable for SLC1_INT_ENA_SPEC {
