#[doc = "Register `SLC0_INT_ST1` reader"]
pub type R = crate::R<SLC0_INT_ST1_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SLC0_INT_ST1_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slc0_int_st1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SLC0_INT_ST1_SPEC;
impl crate::RegisterSpec for SLC0_INT_ST1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slc0_int_st1::R`](R) reader structure"]
impl crate::Readable for SLC0_INT_ST1_SPEC {}
#[doc = "`reset()` method sets SLC0_INT_ST1 to value 0"]
impl crate::Resettable for SLC0_INT_ST1_SPEC {
