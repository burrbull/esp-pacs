#[doc = "Register `SLC0_INT_ENA1` reader"]
pub type R = crate::R<SLC0_INT_ENA1_SPEC>;
#[doc = "Register `SLC0_INT_ENA1` writer"]
pub type W = crate::W<SLC0_INT_ENA1_SPEC>;
...
#[cfg(feature = "impl-register-debug")]
impl core::fmt::Debug for crate::generic::Reg<SLC0_INT_ENA1_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit(&mut self, n: u8) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit0(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 0)
    }
    #[doc = "Bit 1 - FRHOST_BIT1"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit1(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 1)
    }
    #[doc = "Bit 2 - FRHOST_BIT2"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit2(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 2)
    }
    #[doc = "Bit 3 - FRHOST_BIT3"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit3(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 3)
    }
    #[doc = "Bit 4 - FRHOST_BIT4"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit4(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 4)
    }
    #[doc = "Bit 5 - FRHOST_BIT5"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit5(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 5)
    }
    #[doc = "Bit 6 - FRHOST_BIT6"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit6(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 6)
    }
    #[doc = "Bit 7 - FRHOST_BIT7"]
    #[inline(always)]
    #[must_use]
    pub fn frhost_bit7(&mut self) -> FRHOST_BIT_W<SLC0_INT_ENA1_SPEC> {
        FRHOST_BIT_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn rx_start(&mut self) -> RX_START_W<SLC0_INT_ENA1_SPEC> {
        RX_START_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn tx_start(&mut self) -> TX_START_W<SLC0_INT_ENA1_SPEC> {
        TX_START_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn rx_udf(&mut self) -> RX_UDF_W<SLC0_INT_ENA1_SPEC> {
        RX_UDF_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn tx_ovf(&mut self) -> TX_OVF_W<SLC0_INT_ENA1_SPEC> {
        TX_OVF_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn token0_1to0(&mut self) -> TOKEN0_1TO0_W<SLC0_INT_ENA1_SPEC> {
        TOKEN0_1TO0_W::new(self, 12)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn token1_1to0(&mut self) -> TOKEN1_1TO0_W<SLC0_INT_ENA1_SPEC> {
        TOKEN1_1TO0_W::new(self, 13)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn tx_done(&mut self) -> TX_DONE_W<SLC0_INT_ENA1_SPEC> {
        TX_DONE_W::new(self, 14)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn tx_suc_eof(&mut self) -> TX_SUC_EOF_W<SLC0_INT_ENA1_SPEC> {
        TX_SUC_EOF_W::new(self, 15)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn rx_done(&mut self) -> RX_DONE_W<SLC0_INT_ENA1_SPEC> {
        RX_DONE_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn rx_eof(&mut self) -> RX_EOF_W<SLC0_INT_ENA1_SPEC> {
        RX_EOF_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn tohost(&mut self) -> TOHOST_W<SLC0_INT_ENA1_SPEC> {
        TOHOST_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dscr_err(&mut self) -> TX_DSCR_ERR_W<SLC0_INT_ENA1_SPEC> {
        TX_DSCR_ERR_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn rx_dscr_err(&mut self) -> RX_DSCR_ERR_W<SLC0_INT_ENA1_SPEC> {
        RX_DSCR_ERR_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dscr_empty(&mut self) -> TX_DSCR_EMPTY_W<SLC0_INT_ENA1_SPEC> {
        TX_DSCR_EMPTY_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn host_rd_ack(&mut self) -> HOST_RD_ACK_W<SLC0_INT_ENA1_SPEC> {
        HOST_RD_ACK_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn wr_retry_done(&mut self) -> WR_RETRY_DONE_W<SLC0_INT_ENA1_SPEC> {
        WR_RETRY_DONE_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn tx_err_eof(&mut self) -> TX_ERR_EOF_W<SLC0_INT_ENA1_SPEC> {
        TX_ERR_EOF_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn cmd_dtc(&mut self) -> CMD_DTC_W<SLC0_INT_ENA1_SPEC> {
        CMD_DTC_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn rx_quick_eof(&mut self) -> RX_QUICK_EOF_W<SLC0_INT_ENA1_SPEC> {
        RX_QUICK_EOF_W::new(self, 26)
    }
}
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slc0_int_ena1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`slc0_int_ena1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SLC0_INT_ENA1_SPEC;
impl crate::RegisterSpec for SLC0_INT_ENA1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slc0_int_ena1::R`](R) reader structure"]
impl crate::Readable for SLC0_INT_ENA1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`slc0_int_ena1::W`](W) writer structure"]
impl crate::Writable for SLC0_INT_ENA1_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SLC0_INT_ENA1 to value 0"]
impl crate::Resettable for SLC0_INT_ENA1_SPEC {
