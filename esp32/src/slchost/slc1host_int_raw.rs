...
#[doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`slc1host_int_raw::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
