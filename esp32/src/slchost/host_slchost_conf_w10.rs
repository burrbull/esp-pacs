...
impl W {
    ...
    pub fn host_slchost_conf40(
        &mut self,
    ) -> HOST_SLCHOST_CONF40_W<HOST_SLCHOST_CONF_W10_SPEC> {
    ...
    pub fn host_slchost_conf41(
        &mut self,
    ) -> HOST_SLCHOST_CONF41_W<HOST_SLCHOST_CONF_W10_SPEC> {
    ...
    pub fn host_slchost_conf42(
        &mut self,
    ) -> HOST_SLCHOST_CONF42_W<HOST_SLCHOST_CONF_W10_SPEC> {
    ...
    pub fn host_slchost_conf43(
        &mut self,
    ) -> HOST_SLCHOST_CONF43_W<HOST_SLCHOST_CONF_W10_SPEC> {
