...
impl R {
    ...
    #[inline(always)]
    pub fn core_1_iram0_exception_monitor_raw(
        &self,
    ) -> CORE_1_IRAM0_EXCEPTION_MONITOR_RAW_R {
        CORE_1_IRAM0_EXCEPTION_MONITOR_RAW_R::new(((self.bits >> 10) & 1) != 0)
    }
    ///Bit 11 - DBUS busy monitor initerrupt status
    #[inline(always)]
    pub fn core_1_dram0_exception_monitor_raw(
        &self,
    ) -> CORE_1_DRAM0_EXCEPTION_MONITOR_RAW_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_INTR_RAW")
            .field("core_1_area_dram0_0_rd_raw", &self.core_1_area_dram0_0_rd_raw())
            .field("core_1_area_dram0_0_wr_raw", &self.core_1_area_dram0_0_wr_raw())
            .field("core_1_area_dram0_1_rd_raw", &self.core_1_area_dram0_1_rd_raw())
            .field("core_1_area_dram0_1_wr_raw", &self.core_1_area_dram0_1_wr_raw())
