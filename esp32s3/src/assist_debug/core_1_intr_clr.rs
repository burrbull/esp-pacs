...
impl R {
    ...
    pub fn core_1_iram0_exception_monitor_clr(
        &self,
    ) -> CORE_1_IRAM0_EXCEPTION_MONITOR_CLR_R {
    ...
    pub fn core_1_dram0_exception_monitor_clr(
        &self,
    ) -> CORE_1_DRAM0_EXCEPTION_MONITOR_CLR_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_INTR_CLR")
            .field("core_1_area_dram0_0_rd_clr", &self.core_1_area_dram0_0_rd_clr())
            .field("core_1_area_dram0_0_wr_clr", &self.core_1_area_dram0_0_wr_clr())
            .field("core_1_area_dram0_1_rd_clr", &self.core_1_area_dram0_1_rd_clr())
            .field("core_1_area_dram0_1_wr_clr", &self.core_1_area_dram0_1_wr_clr())
