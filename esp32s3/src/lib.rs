...
pub static __INTERRUPTS: [Vector; 99] = [
    ...
    Vector { _handler: GPIO_INTR_2 },
    Vector { _handler: GPIO_NMI_2 },
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            SENSITIVE: SENSITIVE { _marker: PhantomData },
            ...
            SYSTEM: SYSTEM { _marker: PhantomData },
            ...
            WCL: WCL { _marker: PhantomData },
            XTS_AES: XTS_AES { _marker: PhantomData },
        }
    }
}
