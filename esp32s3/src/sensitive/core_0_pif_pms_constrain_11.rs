...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    11,
    u16,
...
pub type CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    11,
    u16,
...
impl R {
    ...
    pub fn core_0_pif_pms_constrain_rtcslow_0_spltaddr_world_0(
        ...
        CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_R::new(
...
impl W {
    ...
    pub fn core_0_pif_pms_constrain_rtcslow_0_spltaddr_world_0(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_0_W<
        CORE_0_PIF_PMS_CONSTRAIN_11_SPEC,
    > {
    ...
    pub fn core_0_pif_pms_constrain_rtcslow_0_spltaddr_world_1(
        &mut self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_RTCSLOW_0_SPLTADDR_WORLD_1_W<
        CORE_0_PIF_PMS_CONSTRAIN_11_SPEC,
    > {
