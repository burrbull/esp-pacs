...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_0_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    3,
>;
...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_1_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    3,
>;
...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_2_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    3,
>;
...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_3_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    3,
>;
...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_CACHEDATAARRAY_PMS_0_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    3,
>;
...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_CACHEDATAARRAY_PMS_1_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    3,
>;
...
pub type CORE_X_IRAM0_PMS_CONSTRAIN_ROM_WORLD_0_PMS_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    3,
>;
impl R {
    ...
    pub fn core_x_iram0_pms_constrain_sram_world_0_pms_1(
        ...
        CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_1_R::new(
            ((self.bits >> 3) & 7) as u8,
        )
    }
    ...
    pub fn core_x_iram0_pms_constrain_sram_world_0_pms_2(
        ...
        CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_2_R::new(
            ((self.bits >> 6) & 7) as u8,
        )
    }
    ...
    pub fn core_x_iram0_pms_constrain_sram_world_0_pms_3(
        ...
        CORE_X_IRAM0_PMS_CONSTRAIN_SRAM_WORLD_0_PMS_3_R::new(
            ((self.bits >> 9) & 7) as u8,
        )
    }
