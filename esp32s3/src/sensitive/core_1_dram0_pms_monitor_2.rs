...
impl R {
    ...
    #[inline(always)]
    pub fn core_1_dram0_pms_monitor_violate_intr(
        &self,
    ) -> CORE_1_DRAM0_PMS_MONITOR_VIOLATE_INTR_R {
    ...
    pub fn core_1_dram0_pms_monitor_violate_status_world(
        ...
        CORE_1_DRAM0_PMS_MONITOR_VIOLATE_STATUS_WORLD_R::new(
            ((self.bits >> 2) & 3) as u8,
        )
    }
    ...
    pub fn core_1_dram0_pms_monitor_violate_status_addr(
        ...
        CORE_1_DRAM0_PMS_MONITOR_VIOLATE_STATUS_ADDR_R::new(
            (self.bits >> 4) & 0x003f_ffff,
        )
    }
}
