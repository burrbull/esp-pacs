...
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_SPLTADDR_WORLD_0_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    11,
    u16,
...
pub type CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_SPLTADDR_WORLD_1_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    11,
    u16,
...
impl R {
    ...
    pub fn core_1_pif_pms_constrain_rtcslow_1_spltaddr_world_0(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_RTCSLOW_1_SPLTADDR_WORLD_0_R::new(
...
impl W {
    ...
    pub fn core_1_pif_pms_constrain_rtcslow_1_spltaddr_world_0(
        ...
        CORE_1_PIF_PMS_CONSTRAIN_13_SPEC,
    > {
