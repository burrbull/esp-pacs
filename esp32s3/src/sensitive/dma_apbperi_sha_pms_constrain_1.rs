...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_1_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_2_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_3_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
...
pub type DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_1_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
impl R {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_cachedataarray_pms_0(
        ...
        DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_CACHEDATAARRAY_PMS_0_R::new(
            ((self.bits >> 8) & 3) as u8,
        )
    }
...
impl W {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_0(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_0_W<
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_1(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_1_W<
        DMA_APBPERI_SHA_PMS_CONSTRAIN_1_SPEC,
    > {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_2(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_2_W<
        DMA_APBPERI_SHA_PMS_CONSTRAIN_1_SPEC,
    > {
    ...
    pub fn dma_apbperi_sha_pms_constrain_sram_pms_3(
        &mut self,
    ) -> DMA_APBPERI_SHA_PMS_CONSTRAIN_SRAM_PMS_3_W<
        DMA_APBPERI_SHA_PMS_CONSTRAIN_1_SPEC,
    > {
