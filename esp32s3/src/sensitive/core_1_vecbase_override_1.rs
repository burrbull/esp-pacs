...
pub type CORE_1_VECBASE_OVERRIDE_WORLD0_VALUE_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    22,
    u32,
...
impl R {
    ...
    pub fn core_1_vecbase_override_world0_value(
        &self,
    ) -> CORE_1_VECBASE_OVERRIDE_WORLD0_VALUE_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE_1_VECBASE_OVERRIDE_1")
            ...
            .field("core_1_vecbase_override_sel", &self.core_1_vecbase_override_sel())
            .finish()
    }
}
impl W {
