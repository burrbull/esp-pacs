...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ICACHE_AUTOLOAD_CTRL")
            ...
            .field("icache_autoload_buffer_clear", &self.icache_autoload_buffer_clear())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icache_autoload_ena(
        &mut self,
    ) -> ICACHE_AUTOLOAD_ENA_W<ICACHE_AUTOLOAD_CTRL_SPEC> {
    ...
    pub fn icache_autoload_order(
        &mut self,
    ) -> ICACHE_AUTOLOAD_ORDER_W<ICACHE_AUTOLOAD_CTRL_SPEC> {
    ...
    pub fn icache_autoload_rqst(
        &mut self,
    ) -> ICACHE_AUTOLOAD_RQST_W<ICACHE_AUTOLOAD_CTRL_SPEC> {
    ...
    pub fn icache_autoload_size(
        &mut self,
    ) -> ICACHE_AUTOLOAD_SIZE_W<ICACHE_AUTOLOAD_CTRL_SPEC> {
