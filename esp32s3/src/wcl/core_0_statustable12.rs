...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_world_12(
        &mut self,
    ) -> CORE_0_FROM_WORLD_12_W<CORE_0_STATUSTABLE12_SPEC> {
        CORE_0_FROM_WORLD_12_W::new(self, 0)
    }
    ///Bits 1:4 - This filed is used to confirm in which entry before enter entry 12
    #[inline(always)]
    #[must_use]
    pub fn core_0_from_entry_12(
        &mut self,
    ) -> CORE_0_FROM_ENTRY_12_W<CORE_0_STATUSTABLE12_SPEC> {
        CORE_0_FROM_ENTRY_12_W::new(self, 1)
    }
    ///Bit 5 - This bit is used to confirm whether the current state is in entry 12
    #[inline(always)]
    #[must_use]
    pub fn core_0_current_12(
        &mut self,
    ) -> CORE_0_CURRENT_12_W<CORE_0_STATUSTABLE12_SPEC> {
