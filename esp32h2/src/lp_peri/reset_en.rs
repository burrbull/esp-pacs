...
#[doc = "Field `BUS` writer - need_des"]
pub type BUS_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LP_BLE_TIMER` reader - need_des"]
pub type LP_BLE_TIMER_R = crate::BitReader;
#[doc = "Field `LP_BLE_TIMER` writer - need_des"]
pub type LP_BLE_TIMER_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
    pub fn lp_ble_timer(&self) -> LP_BLE_TIMER_R {
        LP_BLE_TIMER_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RESET_EN")
            .field(
                "lp_ble_timer",
                &format_args!("{}", self.lp_ble_timer().bit()),
            )
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bus(&mut self) -> BUS_W<RESET_EN_SPEC> {
        BUS_W::new(self, 23)
    }
    #[doc = "Bit 24 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_ble_timer(&mut self) -> LP_BLE_TIMER_W<RESET_EN_SPEC> {
        LP_BLE_TIMER_W::new(self, 24)
    }
    #[doc = "Bit 25 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn otp_dbg(&mut self) -> OTP_DBG_W<RESET_EN_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_io(&mut self) -> LP_IO_W<RESET_EN_SPEC> {
        LP_IO_W::new(self, 27)
    }
    #[doc = "Bit 28 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_ext_i2c(&mut self) -> LP_EXT_I2C_W<RESET_EN_SPEC> {
        LP_EXT_I2C_W::new(self, 28)
    }
    #[doc = "Bit 29 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_ana_i2c(&mut self) -> LP_ANA_I2C_W<RESET_EN_SPEC> {
        LP_ANA_I2C_W::new(self, 29)
    }
    #[doc = "Bit 30 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn efuse(&mut self) -> EFUSE_W<RESET_EN_SPEC> {
        EFUSE_W::new(self, 30)
    }
    #[doc = "Bit 31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn lp_cpu(&mut self) -> LP_CPU_W<RESET_EN_SPEC> {
