...
impl R {
    ...
    pub fn hp_modem_hp_regulator_slp_logic_xpd(
        &self,
    ) -> HP_MODEM_HP_REGULATOR_SLP_LOGIC_XPD_R {
    ...
    pub fn hp_modem_hp_regulator_slp_mem_dbias(
        &self,
    ) -> HP_MODEM_HP_REGULATOR_SLP_MEM_DBIAS_R {
    ...
    pub fn hp_modem_hp_regulator_slp_logic_dbias(
        &self,
    ) -> HP_MODEM_HP_REGULATOR_SLP_LOGIC_DBIAS_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HP_MODEM_HP_REGULATOR0")
            .field("hp_modem_hp_power_det_bypass", &self.hp_modem_hp_power_det_bypass())
            .field(
            ...
            .field("hp_modem_hp_regulator_xpd", &self.hp_modem_hp_regulator_xpd())
            .field(
            ...
            .field("hp_modem_hp_regulator_dbias", &self.hp_modem_hp_regulator_dbias())
            .finish()
    }
}
impl W {
