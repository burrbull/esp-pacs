...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PIN14")
            .field("reg_gpio_pin14_wakeup_enable", &self.reg_gpio_pin14_wakeup_enable())
            .field("reg_gpio_pin14_int_type", &self.reg_gpio_pin14_int_type())
            .field("reg_gpio_pin14_pad_driver", &self.reg_gpio_pin14_pad_driver())
            .finish()
    }
}
impl W {
    ...
    pub fn reg_gpio_pin14_wakeup_enable(
        &mut self,
    ) -> REG_GPIO_PIN14_WAKEUP_ENABLE_W<PIN14_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_pin14_pad_driver(
        &mut self,
    ) -> REG_GPIO_PIN14_PAD_DRIVER_W<PIN14_SPEC> {
