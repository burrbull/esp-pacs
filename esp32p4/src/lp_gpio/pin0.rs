...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PIN0")
            .field("reg_gpio_pin0_wakeup_enable", &self.reg_gpio_pin0_wakeup_enable())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_pin0_wakeup_enable(
        &mut self,
    ) -> REG_GPIO_PIN0_WAKEUP_ENABLE_W<PIN0_SPEC> {
    ...
    pub fn reg_gpio_pin0_edge_wakeup_clr(
        &mut self,
    ) -> REG_GPIO_PIN0_EDGE_WAKEUP_CLR_W<PIN0_SPEC> {
