...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC10_IN_SEL_CFG")
            .field("reg_gpio_func10_in_inv_sel", &self.reg_gpio_func10_in_inv_sel())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_sig10_in_sel(
        &mut self,
    ) -> REG_GPIO_SIG10_IN_SEL_W<FUNC10_IN_SEL_CFG_SPEC> {
    ...
    pub fn reg_gpio_func10_in_sel(
        &mut self,
    ) -> REG_GPIO_FUNC10_IN_SEL_W<FUNC10_IN_SEL_CFG_SPEC> {
