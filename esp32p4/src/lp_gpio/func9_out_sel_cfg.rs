...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC9_OUT_SEL_CFG")
            .field("reg_gpio_func9_oe_inv_sel", &self.reg_gpio_func9_oe_inv_sel())
            .field("reg_gpio_func9_oe_sel", &self.reg_gpio_func9_oe_sel())
            .field("reg_gpio_func9_out_inv_sel", &self.reg_gpio_func9_out_inv_sel())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_func9_oe_sel(
        &mut self,
    ) -> REG_GPIO_FUNC9_OE_SEL_W<FUNC9_OUT_SEL_CFG_SPEC> {
    ...
    pub fn reg_gpio_func9_out_sel(
        &mut self,
    ) -> REG_GPIO_FUNC9_OUT_SEL_W<FUNC9_OUT_SEL_CFG_SPEC> {
