...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC11_IN_SEL_CFG")
            .field("reg_gpio_func11_in_inv_sel", &self.reg_gpio_func11_in_inv_sel())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_sig11_in_sel(
        &mut self,
    ) -> REG_GPIO_SIG11_IN_SEL_W<FUNC11_IN_SEL_CFG_SPEC> {
    ...
    pub fn reg_gpio_func11_in_sel(
        &mut self,
    ) -> REG_GPIO_FUNC11_IN_SEL_W<FUNC11_IN_SEL_CFG_SPEC> {
