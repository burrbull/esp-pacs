...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC11_OUT_SEL_CFG")
            .field("reg_gpio_func11_oe_inv_sel", &self.reg_gpio_func11_oe_inv_sel())
            .field("reg_gpio_func11_oe_sel", &self.reg_gpio_func11_oe_sel())
            .field("reg_gpio_func11_out_inv_sel", &self.reg_gpio_func11_out_inv_sel())
...
impl W {
    ...
    pub fn reg_gpio_func11_oe_sel(
        &mut self,
    ) -> REG_GPIO_FUNC11_OE_SEL_W<FUNC11_OUT_SEL_CFG_SPEC> {
