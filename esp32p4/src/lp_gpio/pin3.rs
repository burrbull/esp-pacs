...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PIN3")
            .field("reg_gpio_pin3_wakeup_enable", &self.reg_gpio_pin3_wakeup_enable())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_pin3_wakeup_enable(
        &mut self,
    ) -> REG_GPIO_PIN3_WAKEUP_ENABLE_W<PIN3_SPEC> {
    ...
    pub fn reg_gpi3_pin0_edge_wakeup_clr(
        &mut self,
    ) -> REG_GPI3_PIN0_EDGE_WAKEUP_CLR_W<PIN3_SPEC> {
