...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PIN12")
            .field("reg_gpio_pin12_wakeup_enable", &self.reg_gpio_pin12_wakeup_enable())
            .field("reg_gpio_pin12_int_type", &self.reg_gpio_pin12_int_type())
            .field("reg_gpio_pin12_pad_driver", &self.reg_gpio_pin12_pad_driver())
            .finish()
    }
}
impl W {
    ...
    pub fn reg_gpio_pin12_wakeup_enable(
        &mut self,
    ) -> REG_GPIO_PIN12_WAKEUP_ENABLE_W<PIN12_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_pin12_pad_driver(
        &mut self,
    ) -> REG_GPIO_PIN12_PAD_DRIVER_W<PIN12_SPEC> {
