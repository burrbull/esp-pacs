...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FUNC7_IN_SEL_CFG")
            .field("reg_gpio_func7_in_inv_sel", &self.reg_gpio_func7_in_inv_sel())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_sig7_in_sel(
        &mut self,
    ) -> REG_GPIO_SIG7_IN_SEL_W<FUNC7_IN_SEL_CFG_SPEC> {
        REG_GPIO_SIG7_IN_SEL_W::new(self, 1)
    }
    ///Bits 2:7 - Reserved
    #[inline(always)]
    #[must_use]
    pub fn reg_gpio_func7_in_sel(
        &mut self,
    ) -> REG_GPIO_FUNC7_IN_SEL_W<FUNC7_IN_SEL_CFG_SPEC> {
