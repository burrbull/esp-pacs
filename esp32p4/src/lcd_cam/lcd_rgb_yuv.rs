...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lcd_conv_8bits_data_inv(
        &mut self,
    ) -> LCD_CONV_8BITS_DATA_INV_W<LCD_RGB_YUV_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lcd_conv_yuv2yuv_mode(
        &mut self,
    ) -> LCD_CONV_YUV2YUV_MODE_W<LCD_RGB_YUV_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lcd_conv_protocol_mode(
        &mut self,
    ) -> LCD_CONV_PROTOCOL_MODE_W<LCD_RGB_YUV_SPEC> {
        LCD_CONV_PROTOCOL_MODE_W::new(self, 26)
    }
    ///Bit 27 - LIMIT or FULL mode of Data out. 0: limit. 1: full
    #[inline(always)]
    #[must_use]
    pub fn lcd_conv_data_out_mode(
        &mut self,
    ) -> LCD_CONV_DATA_OUT_MODE_W<LCD_RGB_YUV_SPEC> {
        LCD_CONV_DATA_OUT_MODE_W::new(self, 27)
    }
    ///Bit 28 - LIMIT or FULL mode of Data in. 0: limit. 1: full
    #[inline(always)]
    #[must_use]
    pub fn lcd_conv_data_in_mode(
        &mut self,
    ) -> LCD_CONV_DATA_IN_MODE_W<LCD_RGB_YUV_SPEC> {
        LCD_CONV_DATA_IN_MODE_W::new(self, 28)
    }
    ///Bit 29 - 0: 16bits mode. 1: 8bits mode.
    #[inline(always)]
    #[must_use]
    pub fn lcd_conv_mode_8bits_on(
        &mut self,
    ) -> LCD_CONV_MODE_8BITS_ON_W<LCD_RGB_YUV_SPEC> {
