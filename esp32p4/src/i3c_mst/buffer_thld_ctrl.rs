...
impl W {
    ...
    pub fn reg_cmd_buf_empty_thld(
        &mut self,
    ) -> REG_CMD_BUF_EMPTY_THLD_W<BUFFER_THLD_CTRL_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_ibi_data_buf_thld(
        &mut self,
    ) -> REG_IBI_DATA_BUF_THLD_W<BUFFER_THLD_CTRL_SPEC> {
    ...
    pub fn reg_ibi_status_buf_thld(
        &mut self,
    ) -> REG_IBI_STATUS_BUF_THLD_W<BUFFER_THLD_CTRL_SPEC> {
