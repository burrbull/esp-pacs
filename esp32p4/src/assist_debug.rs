...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn core_1_lastpc_before_exception(
        &self,
...
pub type CORE_1_LASTPC_BEFORE_EXCEPTION = crate::Reg<
    core_1_lastpc_before_exception::CORE_1_LASTPC_BEFORE_EXCEPTION_SPEC,
>;
///cpu status register
