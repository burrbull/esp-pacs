...
impl W {
    ...
    pub fn _0p1a_cnt_target0_reach_0_hp(
        &mut self,
    ) -> _0P1A_CNT_TARGET0_REACH_0_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p1a_cnt_target1_reach_0_hp(
        &mut self,
    ) -> _0P1A_CNT_TARGET1_REACH_0_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p1a_cnt_target0_reach_1_hp(
        &mut self,
    ) -> _0P1A_CNT_TARGET0_REACH_1_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p1a_cnt_target1_reach_1_hp(
        &mut self,
    ) -> _0P1A_CNT_TARGET1_REACH_1_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target0_reach_0_hp(
        &mut self,
    ) -> _0P2A_CNT_TARGET0_REACH_0_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target1_reach_0_hp(
        &mut self,
    ) -> _0P2A_CNT_TARGET1_REACH_0_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target0_reach_1_hp(
        &mut self,
    ) -> _0P2A_CNT_TARGET0_REACH_1_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p2a_cnt_target1_reach_1_hp(
        &mut self,
    ) -> _0P2A_CNT_TARGET1_REACH_1_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p3a_cnt_target0_reach_0_hp(
        &mut self,
    ) -> _0P3A_CNT_TARGET0_REACH_0_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p3a_cnt_target1_reach_0_hp(
        &mut self,
    ) -> _0P3A_CNT_TARGET1_REACH_0_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p3a_cnt_target0_reach_1_hp(
        &mut self,
    ) -> _0P3A_CNT_TARGET0_REACH_1_HP_W<INT_CLR_SPEC> {
    ...
    pub fn _0p3a_cnt_target1_reach_1_hp(
        &mut self,
    ) -> _0P3A_CNT_TARGET1_REACH_1_HP_W<INT_CLR_SPEC> {
