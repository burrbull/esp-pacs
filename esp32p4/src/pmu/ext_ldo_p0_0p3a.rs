...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn _0p3a_force_tieh_sel_0(
        &mut self,
    ) -> _0P3A_FORCE_TIEH_SEL_0_W<EXT_LDO_P0_0P3A_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn _0p3a_tieh_pos_en_0(
        &mut self,
    ) -> _0P3A_TIEH_POS_EN_0_W<EXT_LDO_P0_0P3A_SPEC> {
        _0P3A_TIEH_POS_EN_0_W::new(self, 12)
    }
    ///Bit 13 - need_des
    #[inline(always)]
    #[must_use]
    pub fn _0p3a_tieh_neg_en_0(
        &mut self,
    ) -> _0P3A_TIEH_NEG_EN_0_W<EXT_LDO_P0_0P3A_SPEC> {
