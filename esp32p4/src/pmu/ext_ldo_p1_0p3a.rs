...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn _0p3a_force_tieh_sel_1(
        &mut self,
    ) -> _0P3A_FORCE_TIEH_SEL_1_W<EXT_LDO_P1_0P3A_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn _0p3a_tieh_pos_en_1(
        &mut self,
    ) -> _0P3A_TIEH_POS_EN_1_W<EXT_LDO_P1_0P3A_SPEC> {
        _0P3A_TIEH_POS_EN_1_W::new(self, 12)
    }
    ///Bit 13 - need_des
    #[inline(always)]
    #[must_use]
    pub fn _0p3a_tieh_neg_en_1(
        &mut self,
    ) -> _0P3A_TIEH_NEG_EN_1_W<EXT_LDO_P1_0P3A_SPEC> {
