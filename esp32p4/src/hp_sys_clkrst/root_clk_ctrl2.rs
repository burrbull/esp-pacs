...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sys_clk_div_numerator(
        &mut self,
    ) -> SYS_CLK_DIV_NUMERATOR_W<ROOT_CLK_CTRL2_SPEC> {
    ...
    pub fn sys_clk_div_denominator(
        &mut self,
    ) -> SYS_CLK_DIV_DENOMINATOR_W<ROOT_CLK_CTRL2_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn apb_clk_div_numerator(
        &mut self,
    ) -> APB_CLK_DIV_NUMERATOR_W<ROOT_CLK_CTRL2_SPEC> {
