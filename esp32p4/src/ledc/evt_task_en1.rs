...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn task_sig_out_dis_ch6_en(
        &mut self,
    ) -> TASK_SIG_OUT_DIS_CH6_EN_W<EVT_TASK_EN1_SPEC> {
        TASK_SIG_OUT_DIS_CH6_EN_W::new(self, 14)
    }
    ///Bit 15 - Configures whether or not to enable ledc_ch7_sig_out_dis task.\\0: Disable\\1: Enable
    #[inline(always)]
    #[must_use]
    pub fn task_sig_out_dis_ch7_en(
        &mut self,
    ) -> TASK_SIG_OUT_DIS_CH7_EN_W<EVT_TASK_EN1_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn task_ovf_cnt_rst_ch6_en(
        &mut self,
    ) -> TASK_OVF_CNT_RST_CH6_EN_W<EVT_TASK_EN1_SPEC> {
        TASK_OVF_CNT_RST_CH6_EN_W::new(self, 22)
    }
    ///Bit 23 - Configures whether or not to enable ledc_ch7_ovf_cnt_rst task.\\0: Disable\\1: Enable
    #[inline(always)]
    #[must_use]
    pub fn task_ovf_cnt_rst_ch7_en(
        &mut self,
    ) -> TASK_OVF_CNT_RST_CH7_EN_W<EVT_TASK_EN1_SPEC> {
