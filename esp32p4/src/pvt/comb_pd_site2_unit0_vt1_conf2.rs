...
impl R {
    ...
    pub fn monitor_edg_mod_vt1_pd_site2_unit0(
        &self,
    ) -> MONITOR_EDG_MOD_VT1_PD_SITE2_UNIT0_R {
    ...
    #[inline(always)]
    pub fn timing_err_cnt_o_vt1_pd_site2_unit0(
        &self,
    ) -> TIMING_ERR_CNT_O_VT1_PD_SITE2_UNIT0_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE2_UNIT0_VT1_CONF2")
            ...
            .field("delay_ovf_vt1_pd_site2_unit0", &self.delay_ovf_vt1_pd_site2_unit0())
            .field(
