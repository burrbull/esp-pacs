...
impl R {
    ...
    pub fn monitor_edg_mod_vt0_pd_site2_unit2(
        &self,
    ) -> MONITOR_EDG_MOD_VT0_PD_SITE2_UNIT2_R {
    ...
    #[inline(always)]
    pub fn timing_err_cnt_o_vt0_pd_site2_unit2(
        &self,
    ) -> TIMING_ERR_CNT_O_VT0_PD_SITE2_UNIT2_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("COMB_PD_SITE2_UNIT2_VT0_CONF2")
            ...
            .field("delay_ovf_vt0_pd_site2_unit2", &self.delay_ovf_vt0_pd_site2_unit2())
            .field(
