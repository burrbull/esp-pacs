...
impl R {
    ...
    #[inline(always)]
    pub fn l1_icache2_autoload_trigger_mode(
        &self,
    ) -> L1_ICACHE2_AUTOLOAD_TRIGGER_MODE_R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_ICACHE2_AUTOLOAD_CTRL")
            ...
            .field("l1_icache2_autoload_order", &self.l1_icache2_autoload_order())
            .field(
                "l1_icache2_autoload_trigger_mode",
                &self.l1_icache2_autoload_trigger_mode(),
            )
            .field("l1_icache2_autoload_sct0_ena", &self.l1_icache2_autoload_sct0_ena())
            .field("l1_icache2_autoload_sct1_ena", &self.l1_icache2_autoload_sct1_ena())
