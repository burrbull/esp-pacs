...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_DCACHE_AUTOLOAD_CTRL")
            ...
            .field("l1_dcache_autoload_sct0_ena", &self.l1_dcache_autoload_sct0_ena())
            .field("l1_dcache_autoload_sct1_ena", &self.l1_dcache_autoload_sct1_ena())
            .field("l1_dcache_autoload_sct2_ena", &self.l1_dcache_autoload_sct2_ena())
            .field("l1_dcache_autoload_sct3_ena", &self.l1_dcache_autoload_sct3_ena())
