...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l1_ibus0_cnt_ena(
        &mut self,
    ) -> L1_IBUS0_CNT_ENA_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
        L1_IBUS0_CNT_ENA_W::new(self, 0)
    }
    ///Bit 1 - The bit is used to enable ibus1 counter in L1-ICache1.
    #[inline(always)]
    #[must_use]
    pub fn l1_ibus1_cnt_ena(
        &mut self,
    ) -> L1_IBUS1_CNT_ENA_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
        L1_IBUS1_CNT_ENA_W::new(self, 1)
    }
    ///Bit 4 - The bit is used to enable dbus0 counter in L1-DCache.
    #[inline(always)]
    #[must_use]
    pub fn l1_dbus0_cnt_ena(
        &mut self,
    ) -> L1_DBUS0_CNT_ENA_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
        L1_DBUS0_CNT_ENA_W::new(self, 4)
    }
    ///Bit 5 - The bit is used to enable dbus1 counter in L1-DCache.
    #[inline(always)]
    #[must_use]
    pub fn l1_dbus1_cnt_ena(
        &mut self,
    ) -> L1_DBUS1_CNT_ENA_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
        L1_DBUS1_CNT_ENA_W::new(self, 5)
    }
    ///Bit 16 - The bit is used to clear ibus0 counter in L1-ICache0.
    #[inline(always)]
    #[must_use]
    pub fn l1_ibus0_cnt_clr(
        &mut self,
    ) -> L1_IBUS0_CNT_CLR_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
        L1_IBUS0_CNT_CLR_W::new(self, 16)
    }
    ///Bit 17 - The bit is used to clear ibus1 counter in L1-ICache1.
    #[inline(always)]
    #[must_use]
    pub fn l1_ibus1_cnt_clr(
        &mut self,
    ) -> L1_IBUS1_CNT_CLR_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
        L1_IBUS1_CNT_CLR_W::new(self, 17)
    }
    ///Bit 20 - The bit is used to clear dbus0 counter in L1-DCache.
    #[inline(always)]
    #[must_use]
    pub fn l1_dbus0_cnt_clr(
        &mut self,
    ) -> L1_DBUS0_CNT_CLR_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
        L1_DBUS0_CNT_CLR_W::new(self, 20)
    }
    ///Bit 21 - The bit is used to clear dbus1 counter in L1-DCache.
    #[inline(always)]
    #[must_use]
    pub fn l1_dbus1_cnt_clr(
        &mut self,
    ) -> L1_DBUS1_CNT_CLR_W<L1_CACHE_ACS_CNT_CTRL_SPEC> {
