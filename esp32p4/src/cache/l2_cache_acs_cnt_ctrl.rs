...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l2_ibus0_cnt_ena(
        &mut self,
    ) -> L2_IBUS0_CNT_ENA_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_IBUS0_CNT_ENA_W::new(self, 8)
    }
    ///Bit 9 - The bit is used to enable ibus1 counter in L2-Cache.
    #[inline(always)]
    #[must_use]
    pub fn l2_ibus1_cnt_ena(
        &mut self,
    ) -> L2_IBUS1_CNT_ENA_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_IBUS1_CNT_ENA_W::new(self, 9)
    }
    ///Bit 12 - The bit is used to enable dbus0 counter in L2-Cache.
    #[inline(always)]
    #[must_use]
    pub fn l2_dbus0_cnt_ena(
        &mut self,
    ) -> L2_DBUS0_CNT_ENA_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_DBUS0_CNT_ENA_W::new(self, 12)
    }
    ///Bit 13 - The bit is used to enable dbus1 counter in L2-Cache.
    #[inline(always)]
    #[must_use]
    pub fn l2_dbus1_cnt_ena(
        &mut self,
    ) -> L2_DBUS1_CNT_ENA_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_DBUS1_CNT_ENA_W::new(self, 13)
    }
    ///Bit 24 - The bit is used to clear ibus0 counter in L2-Cache.
    #[inline(always)]
    #[must_use]
    pub fn l2_ibus0_cnt_clr(
        &mut self,
    ) -> L2_IBUS0_CNT_CLR_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_IBUS0_CNT_CLR_W::new(self, 24)
    }
    ///Bit 25 - The bit is used to clear ibus1 counter in L2-Cache.
    #[inline(always)]
    #[must_use]
    pub fn l2_ibus1_cnt_clr(
        &mut self,
    ) -> L2_IBUS1_CNT_CLR_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_IBUS1_CNT_CLR_W::new(self, 25)
    }
    ///Bit 28 - The bit is used to clear dbus0 counter in L2-Cache.
    #[inline(always)]
    #[must_use]
    pub fn l2_dbus0_cnt_clr(
        &mut self,
    ) -> L2_DBUS0_CNT_CLR_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
        L2_DBUS0_CNT_CLR_W::new(self, 28)
    }
    ///Bit 29 - The bit is used to clear dbus1 counter in L2-Cache.
    #[inline(always)]
    #[must_use]
    pub fn l2_dbus1_cnt_clr(
        &mut self,
    ) -> L2_DBUS1_CNT_CLR_W<L2_CACHE_ACS_CNT_CTRL_SPEC> {
