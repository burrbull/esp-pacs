...
impl W {
    ...
    pub fn l1_icache0_tag_object(
        &mut self,
    ) -> L1_ICACHE0_TAG_OBJECT_W<L1_CACHE_OBJECT_CTRL_SPEC> {
    ...
    pub fn l1_icache1_tag_object(
        &mut self,
    ) -> L1_ICACHE1_TAG_OBJECT_W<L1_CACHE_OBJECT_CTRL_SPEC> {
    ...
    pub fn l1_dcache_tag_object(
        &mut self,
    ) -> L1_DCACHE_TAG_OBJECT_W<L1_CACHE_OBJECT_CTRL_SPEC> {
    ...
    pub fn l1_icache0_mem_object(
        &mut self,
    ) -> L1_ICACHE0_MEM_OBJECT_W<L1_CACHE_OBJECT_CTRL_SPEC> {
    ...
    pub fn l1_icache1_mem_object(
        &mut self,
    ) -> L1_ICACHE1_MEM_OBJECT_W<L1_CACHE_OBJECT_CTRL_SPEC> {
    ...
    pub fn l1_dcache_mem_object(
        &mut self,
    ) -> L1_DCACHE_MEM_OBJECT_W<L1_CACHE_OBJECT_CTRL_SPEC> {
