...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DEV_ADDR_TABLE11_LOC")
            .field("reg_dat_dev11_static_addr", &self.reg_dat_dev11_static_addr())
            .field("reg_dat_dev11_dynamic_addr", &self.reg_dat_dev11_dynamic_addr())
            .field("reg_dat_dev11_nack_retry_cnt", &self.reg_dat_dev11_nack_retry_cnt())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reg_dat_dev11_i2c(
        &mut self,
    ) -> REG_DAT_DEV11_I2C_W<DEV_ADDR_TABLE11_LOC_SPEC> {
