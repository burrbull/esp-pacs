...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn yn1(&mut self) -> YN1_W<LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        YN1_W::new(self, 4)
    }
    #[doc = "Bits 5:13 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn z(&mut self) -> Z_W<LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        Z_W::new(self, 5)
    }
    #[doc = "Bits 14:22 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn y(&mut self) -> Y_W<LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        Y_W::new(self, 14)
    }
    #[doc = "Bits 23:31 - need_des"]
    #[inline(always)]
    #[must_use]
    pub fn x(&mut self) -> X_W<LP_I2S_RXCLK_DIV_XYZ_SPEC> {
        X_W::new(self, 23)
    }
}
