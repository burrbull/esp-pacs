...
#[doc = "Field `NUM` reader - need_des"]
pub type NUM_R = crate::FieldReader;
#[doc = "Field `NUM` writer - need_des"]
pub type NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 24:31 - need_des"]
    #[inline(always)]
    pub fn num(&self) -> NUM_R {
        NUM_R::new(((self.bits >> 24) & 0xff) as u8)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn num(&mut self) -> NUM_W<LP_I2S_RXCLK_DIV_NUM_SPEC> {
        NUM_W::new(self, 24)
    }
}
