...
pub type CH1_ENABLE_SHADOWREG_OR_LLI_INVALID_ERR_INTSIGNAL_W<'a, REG> = crate::BitWriter<
    'a,
    REG,
>;
...
pub type CH1_ENABLE_SLVIF_MULTIBLKTYPE_ERR_INTSIGNAL_W<'a, REG> = crate::BitWriter<
    'a,
    REG,
>;
...
pub type CH1_ENABLE_SLVIF_SHADOWREG_WRON_VALID_ERR_INTSIGNAL_W<'a, REG> = crate::BitWriter<
    'a,
    REG,
>;
...
impl R {
    ...
    pub fn ch1_enable_block_tfr_done_intsignal(
        &self,
    ) -> CH1_ENABLE_BLOCK_TFR_DONE_INTSIGNAL_R {
    ...
    pub fn ch1_enable_dma_tfr_done_intsignal(
        &self,
    ) -> CH1_ENABLE_DMA_TFR_DONE_INTSIGNAL_R {
    ...
    pub fn ch1_enable_src_transcomp_intsignal(
        &self,
    ) -> CH1_ENABLE_SRC_TRANSCOMP_INTSIGNAL_R {
    ...
    pub fn ch1_enable_dst_transcomp_intsignal(
        &self,
    ) -> CH1_ENABLE_DST_TRANSCOMP_INTSIGNAL_R {
    ...
    pub fn ch1_enable_src_dec_err_intsignal(
        &self,
    ) -> CH1_ENABLE_SRC_DEC_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_dst_dec_err_intsignal(
        &self,
    ) -> CH1_ENABLE_DST_DEC_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_src_slv_err_intsignal(
        &self,
    ) -> CH1_ENABLE_SRC_SLV_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_lli_rd_dec_err_intsignal(
        &self,
    ) -> CH1_ENABLE_LLI_RD_DEC_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_lli_rd_slv_err_intsignal(
        &self,
    ) -> CH1_ENABLE_LLI_RD_SLV_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_lli_wr_slv_err_intsignal(
        &self,
    ) -> CH1_ENABLE_LLI_WR_SLV_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_shadowreg_or_lli_invalid_err_intsignal(
        ...
        CH1_ENABLE_SHADOWREG_OR_LLI_INVALID_ERR_INTSIGNAL_R::new(
            ((self.bits >> 13) & 1) != 0,
        )
    }
    ///Bit 14 - NA
    ...
    pub fn ch1_enable_slvif_dec_err_intsignal(
        &self,
    ) -> CH1_ENABLE_SLVIF_DEC_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_slvif_wr2ro_err_intsignal(
        &self,
    ) -> CH1_ENABLE_SLVIF_WR2RO_ERR_INTSIGNAL_R {
    ...
    pub fn ch1_enable_slvif_shadowreg_wron_valid_err_intsignal(
        ...
        CH1_ENABLE_SLVIF_SHADOWREG_WRON_VALID_ERR_INTSIGNAL_R::new(
            ((self.bits >> 20) & 1) != 0,
        )
    }
    ///Bit 21 - NA
    ...
    pub fn ch1_enable_ch_lock_cleared_intsignal(
        &self,
    ) -> CH1_ENABLE_CH_LOCK_CLEARED_INTSIGNAL_R {
    ...
    pub fn ch1_enable_ch_src_suspended_intsignal(
        &self,
    ) -> CH1_ENABLE_CH_SRC_SUSPENDED_INTSIGNAL_R {
    ...
    pub fn ch1_enable_ch_suspended_intsignal(
        &self,
    ) -> CH1_ENABLE_CH_SUSPENDED_INTSIGNAL_R {
    ...
    pub fn ch1_enable_ch_disabled_intsignal(
        &self,
    ) -> CH1_ENABLE_CH_DISABLED_INTSIGNAL_R {
