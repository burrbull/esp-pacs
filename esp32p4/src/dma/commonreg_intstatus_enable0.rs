...
pub type ENABLE_SLVIF_COMMONREG_WRONHOLD_ERR_INTSTAT_W<'a, REG> = crate::BitWriter<
    'a,
    REG,
>;
...
pub type ENABLE_SLVIF_UNDEFINEDREG_DEC_ERR_INTSTAT_W<'a, REG> = crate::BitWriter<
    'a,
    REG,
>;
...
impl W {
    ...
    pub fn enable_slvif_commonreg_wronhold_err_intstat(
        &mut self,
    ) -> ENABLE_SLVIF_COMMONREG_WRONHOLD_ERR_INTSTAT_W<
        COMMONREG_INTSTATUS_ENABLE0_SPEC,
    > {
