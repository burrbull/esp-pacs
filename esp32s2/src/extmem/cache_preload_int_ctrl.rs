...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CACHE_PRELOAD_INT_CTRL")
            .field("pro_icache_preload_int_st", &self.pro_icache_preload_int_st())
            .field("pro_icache_preload_int_ena", &self.pro_icache_preload_int_ena())
            .field("pro_dcache_preload_int_st", &self.pro_dcache_preload_int_st())
            .field("pro_dcache_preload_int_ena", &self.pro_dcache_preload_int_ena())
            .finish()
    }
}
impl W {
