...
pub type CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_TIMER_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
...
pub type CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_WDG_W<'a, REG> = crate::FieldWriter<
    'a,
    REG,
    2,
>;
...
impl R {
    ...
    pub fn core_0_pif_pms_constrain_world_0_wdg(
        &self,
    ) -> CORE_0_PIF_PMS_CONSTRAIN_WORLD_0_WDG_R {
