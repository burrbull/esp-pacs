...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s_tx_clkm_div_z(
        &mut self,
    ) -> I2S_TX_CLKM_DIV_Z_W<I2S_TX_CLKM_DIV_CONF_SPEC> {
        I2S_TX_CLKM_DIV_Z_W::new(self, 0)
    }
    ///Bits 9:17 - For b &lt;= a/2, the value of I2S_TX_CLKM_DIV_Y is (a%b) . For b > a/2, the value of I2S_TX_CLKM_DIV_Y is (a%(a-b)).
    #[inline(always)]
    #[must_use]
    pub fn i2s_tx_clkm_div_y(
        &mut self,
    ) -> I2S_TX_CLKM_DIV_Y_W<I2S_TX_CLKM_DIV_CONF_SPEC> {
        I2S_TX_CLKM_DIV_Y_W::new(self, 9)
    }
    ///Bits 18:26 - For b &lt;= a/2, the value of I2S_TX_CLKM_DIV_X is (a/b) - 1. For b > a/2, the value of I2S_TX_CLKM_DIV_X is (a/(a-b)) - 1.
    #[inline(always)]
    #[must_use]
    pub fn i2s_tx_clkm_div_x(
        &mut self,
    ) -> I2S_TX_CLKM_DIV_X_W<I2S_TX_CLKM_DIV_CONF_SPEC> {
        I2S_TX_CLKM_DIV_X_W::new(self, 18)
    }
    ///Bit 27 - For b &lt;= a/2, the value of I2S_TX_CLKM_DIV_YN1 is 0 . For b > a/2, the value of I2S_TX_CLKM_DIV_YN1 is 1.
    #[inline(always)]
    #[must_use]
    pub fn i2s_tx_clkm_div_yn1(
        &mut self,
    ) -> I2S_TX_CLKM_DIV_YN1_W<I2S_TX_CLKM_DIV_CONF_SPEC> {
