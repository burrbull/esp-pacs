...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("I2C0_CONF")
            .field("lp_i2c_ana_mast_i2c0_conf", &self.lp_i2c_ana_mast_i2c0_conf())
            .field("lp_i2c_ana_mast_i2c0_status", &self.lp_i2c_ana_mast_i2c0_status())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lp_i2c_ana_mast_i2c0_conf(
        &mut self,
    ) -> LP_I2C_ANA_MAST_I2C0_CONF_W<I2C0_CONF_SPEC> {
