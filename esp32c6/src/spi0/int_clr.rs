...
#[doc = "Field `ECC_ERR_INT_CLR` reader - The clear bit for SPI_MEM_ECC_ERR_INT interrupt."]
pub type ECC_ERR_INT_CLR_R = crate::BitReader;
...
#[doc = "Field `AXI_WR_FLASH_ERR_INT_CLR` reader - The clear bit for SPI_MEM_AXI_WR_FALSH_ERR_INT interrupt."]
pub type AXI_WR_FLASH_ERR_INT_CLR_R = crate::BitReader;
#[doc = "Field `AXI_WADDR_ERR_INT_CLR` reader - The clear bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt."]
pub type AXI_WADDR_ERR_INT_CLR_R = crate::BitReader;
impl R {
    #[doc = "Bit 5 - The clear bit for SPI_MEM_ECC_ERR_INT interrupt."]
    #[inline(always)]
    pub fn ecc_err_int_clr(&self) -> ECC_ERR_INT_CLR_R {
        ECC_ERR_INT_CLR_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 8 - The clear bit for SPI_MEM_AXI_WR_FALSH_ERR_INT interrupt."]
    #[inline(always)]
    pub fn axi_wr_flash_err_int_clr(&self) -> AXI_WR_FLASH_ERR_INT_CLR_R {
        AXI_WR_FLASH_ERR_INT_CLR_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - The clear bit for SPI_MEM_AXI_WADDR_ERR_INT interrupt."]
    #[inline(always)]
    pub fn axi_waddr_err_int_clr(&self) -> AXI_WADDR_ERR_INT_CLR_R {
        AXI_WADDR_ERR_INT_CLR_R::new(((self.bits >> 9) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("INT_CLR")
            .field(
                "ecc_err_int_clr",
                &format_args!("{}", self.ecc_err_int_clr().bit()),
            )
            .field(
                "axi_wr_flash_err_int_clr",
                &format_args!("{}", self.axi_wr_flash_err_int_clr().bit()),
            )
            .field(
                "axi_waddr_err_int_clr",
                &format_args!("{}", self.axi_waddr_err_int_clr().bit()),
            )
            .finish()
    }
}
