...
impl W {
    ...
    pub fn modem_switch_active_end(
        &mut self,
    ) -> MODEM_SWITCH_ACTIVE_END_W<LP_INT_ENA_SPEC> {
    ...
    pub fn sleep_switch_modem_end(
        &mut self,
    ) -> SLEEP_SWITCH_MODEM_END_W<LP_INT_ENA_SPEC> {
    ...
    pub fn modem_switch_sleep_end(
        &mut self,
    ) -> MODEM_SWITCH_SLEEP_END_W<LP_INT_ENA_SPEC> {
    ...
    pub fn modem_switch_active_start(
        &mut self,
    ) -> MODEM_SWITCH_ACTIVE_START_W<LP_INT_ENA_SPEC> {
    ...
    pub fn sleep_switch_modem_start(
        &mut self,
    ) -> SLEEP_SWITCH_MODEM_START_W<LP_INT_ENA_SPEC> {
    ...
    pub fn modem_switch_sleep_start(
        &mut self,
    ) -> MODEM_SWITCH_SLEEP_START_W<LP_INT_ENA_SPEC> {
