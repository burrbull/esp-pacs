...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("L1_CACHE_DATA_MEM_POWER_CTRL")
            ...
            .field("l1_cache_data_mem_force_on", &self.l1_cache_data_mem_force_on())
            .field("l1_cache_data_mem_force_pd", &self.l1_cache_data_mem_force_pd())
            .field("l1_cache_data_mem_force_pu", &self.l1_cache_data_mem_force_pu())
            .finish()
    }
}
impl W {
